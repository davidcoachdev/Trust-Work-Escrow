            ...
            div { class: "relative wrap",
                ...
                Reveal {
                    div { class: "mt-8 flex gap-4 justify-center flex-wrap",
                        ...
                        Link { class: "inline-flex items-center justify-center gap-2 rounded-xl px-5 py-3 text-base font-medium border border-primary text-primary bg-transparent transition hover:-translate-y-0.5 active:scale-[0.98]", to: Route::LoginPage {}, {tr(l, "nav.login")} }
                    }
                }
                Reveal {
