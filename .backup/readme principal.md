...
- [📚 Readme for App ✨](#-readme-for-app-)
  ...
  - [🤵‍♂️Teams 🔝](#️teams-)
    - [👷‍♂️ Proyect Manager 🔝](#️-proyect-manager-)
    - [🧑‍💻 Frontend 🔝](#-frontend-)
    - [💻 Backend 🔝](#-backend-)
...
Testimonial CMS is a platform designed for institutions and companies aiming to showcase the real impact of their programs or products through authentic testimonials in text, video, or image format. It provides tools to create, organize, and publish stories with curation, moderation, and engagement analytics, allowing classification by categories, smart search, tagging, and easy sharing via embeds or public API. Built with modern technologies like Next.js or NestJS, PostgreSQL, YouTube API, and Cloudinary, it delivers a robust and flexible system with admin, editor, and viewer roles.
...
[![Discord Link](https://img.shields.io/badge/Discord-7289DA?style=for-the-badge&logo=discord&logoColor=white 'Discord Link')](https://discord.gg/x2zfcbJa)
[![LinkedIn](https://custom-icon-badges.demolab.com/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin-white&logoColor=fff)](https://www.linkedin.com/company/nocountrytalent/posts/?feedView=all)
...
### 👷‍♂️ Proyect Manager [🔝](#readme-for--restify-app-)
...
|![Avatar](https://avatars.githubusercontent.com/u/118417684?s=96&v=4) |
|:-:|
|**Jose Ortega**|
| [![Github Link](https://img.shields.io/badge/github-%23121011.svg?&style=for-the-badge&logo=github&logoColor=white 'Github Link')](https://github.com/joseorteha) [![LinkedIn Link](https://custom-icon-badges.demolab.com/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin-white&logoColor=fff 'LinkedIn Link')](https://www.linkedin.com/in/jose-orteg) |
...
|:-: |:-: | :-: |
| Repository | [![Github Link](https://img.shields.io/badge/github-%23121011.svg?&style=for-the-badge&logo=github&logoColor=white 'Github Link')](https://github.com/No-Country/c17-29-n-node) | [Repository](https://github.com/No-Country-simulation/S11-25-Equipo-60-WebApp 'Repo App') |
| Forntend | [![Vercel Link](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white 'Vercel Link')](https://vercel.com/) |[Landing](https://testimonial-cms.vercel.app) |
| Backend | [![Vercel Link](https://img.shields.io/badge/Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white 'Vercel Link')](https://vercel.com/) |[Documentation](https://apptestimonial.vercel.app/app/docs/) |
