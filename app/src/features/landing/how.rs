...
pub fn HowItWorks() -> Element {
    ...
    let steps = [
        ("how.step1.title", "how.step1.body", "01"),
        ("how.step2.title", "how.step2.body", "02"),
        ("how.step3.title", "how.step3.body", "03"),
    ];
    rsx! {
        section { class: "py-24 bg-surface",
            div { class: "wrap",
                ...
                div { class: "grid gap-6 sm:grid-cols-2 lg:grid-cols-3",
                    for (title, body, n) in steps {
                        div { class: "relative bg-bg border border-border rounded-2xl p-7",
