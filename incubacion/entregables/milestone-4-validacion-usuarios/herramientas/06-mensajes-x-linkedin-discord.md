...
## 🐦 X (Twitter) — 3 opciones

**Opción A (thread corto, recomendada):**
```
Freelancer Web3? ¿Tu mayor dolor con Upwork: comisiones altas o pagos lentos? 🧵
...
**Opción B (DM a founder / cliente tech-savvy):**
```
Hola [Nombre], veo que contratás talento tech/Web3. Estamos validando Trust Work Escrow, un escrow descentralizado en Solana donde el pago se bloquea al inicio y se libera al aprobar el trabajo (sin comisión de plataforma).

¿Tenés 15 min para una charla sobre cómo manejás pagos a freelancers hoy y qué te daría confianza en una plataforma nueva? Solo investigación, sin compromiso. ¡Gracias!
```

---

## 🎮 Discord (Solana — canal #dev o #general)
