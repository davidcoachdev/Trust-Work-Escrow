# 📤 Compartir Encuesta — Discord y WhatsApp
...
```
🚀 ¡Hola comunidad! Somos Trust Work Escrow 🔐
...
- `04-encuesta-online.md` → diseño de la encuesta (26 preg).
- `google-forms-script.js` → crea el form y devuelve el link.
- `05-mensajes-difusion.md` / `06-mensajes-x-linkedin-discord.md` → otras versiones de difusión.
- `07-invitacion-entrevistas.md` → DMs para entrevistas 1:1 (no para la encuesta).
