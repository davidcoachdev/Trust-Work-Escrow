# 📣 Mensajes de Difusión — Trust Work Escrow

**Milestone:** 4 — Validación Inicial con Usuarios
**Uso:** reclutar entrevistados 1:1 y respuestas a la encuesta. Adaptá el tono por canal. El segmento objetivo está en `02-mercado-objetivo.md` (freelancer tech crypto-native).

> 🎯 Call to action siempre claro: o bien "entrevista de 20 min" o bien "link a la encuesta de 3 min". No pidas ambas a la vez.

---

## 1. r/solana (Reddit) — post de comunidad

**Título:** Freelancers dev/Web3: ¿qué odiás de Upwork/Fiverr? 20 min de charla 💬

**Cuerpo:**
```
Hola! Estamos construyendo Trust Work Escrow, un sistema de pago freelance con escrow on-chain en Solana (comisión <5%, pago inmediato al aprobar entrega).
...
Gracias 🙏 (no es shill, es user research)
```

---

## 2. Discord Solana (canal #dev o #general) — mensaje corto
...
## 3. Telegram (grupos Solana / Web3 LATAM)
...
## 4. LinkedIn (DM a founders / clientes tech-savvy)

**Asunto:** consulta rápida sobre contratar freelancers Web3

**Cuerpo:**
```
Hola [Nombre], veo que contratás talento tech/Web3. Estamos validando Trust Work Escrow, un sistema de escrow descentralizado en Solana donde el pago se bloquea al inicio y se libera al aprobar el trabajo (sin comisiones de plataforma).

¿Tenés 15 min para una charla sobre cómo manejás pagos a freelancers hoy y qué te daría confianza en una plataforma nueva? Es solo investigación, sin compromiso.
...
## 5. LinkedIn (post público, para alcance)

```
Freelancers tech: ¿pagan 20% de comisión en Upwork y esperan 2 semanas el pago? 🤔
...
## 6. Twitter / X (thread corto)

```
1/ Freelancer Web3? ¿Tu mayor dolor con Upwork: comisiones altas o pagos lentos? 🧵
...
- [ ] Tenés listo el template de registro (`01-preguntas-entrevista.md`) para anotar las entrevistas que cerres.

---

## 🔗 Coherencia
- `02-mercado-objetivo.md` → define a quién apuntás (freelancer crypto-native).
- `01-preguntas-entrevista.md` → guion para las entrevistas que cierres desde acá.
- `04-encuesta-online.md` → la encuesta que linkeás.
