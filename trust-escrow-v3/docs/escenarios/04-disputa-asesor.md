...
4. **Asesor** → `resolve_platform_case(job_id, client_pct, freelancer_pct)`
   - El asesor actúa como resolutor y **cobra el 5%** de los bonos ya posteados.
...
## Postcondiciones
- La disputa **se abrió** → se cobra sí o sí. El asesor cobra el 5%.
- Quien no aceptó igual paga su 2.5% (vía bono posteado o descontado de su parte).

## Resumen de fees
- Plataforma: `fee_amount`. Arbitraje: 5% al **asesor** (porque resolvió la
  disputa abierta; no es "gratis" porque sí se abrió).
