...
| Evidence/payout conservation | Evidence PDA x10, cleanup parcial/final, arbitration treasury y conservación ejercitados en el flujo de disputa | PARTIAL (suite completa afectada por expiraciones Surfpool) |
...
| Docs/IDL | generated IDL plus semantic `yarn check:docs` over all Markdown docs; no inline Evidence collection or resolver fee wording | PASS |
